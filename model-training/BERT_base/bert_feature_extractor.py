...
def trainBERT(model, train_loader, val_loader, lr=2e-2,num_epoch=10):
    # Training steps
...
print('*** Training BERT Feature Extractor...')
train_loss_BERT, train_acc_BERT, val_loss_BERT, val_acc_BERT, val_auc_BERT, model_BERT = trainBERT(model, 
                                                                                     train_loaderB, 
                                                                                     val_loaderB)
                                                                                     
print('*** Saving best model...')
model_name = 'model_bert_pretrained_fc'
